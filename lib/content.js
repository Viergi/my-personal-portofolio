...
const home = {
  id: {
    title: "Halo, saya",
    description:
      "Saya adalah seorang software engineer yang bersemangat dalam membangun solusi digital. Saya menciptakan perangkat lunak yang andal, efisien, dan berdampak positif bagi pengguna.",
    cv: "Unduh CV",
  },
  en: {
    title: "Hello, I'm ",
    description:
      "I'm a passionate software engineer dedicated to building digital solutions. I create reliable, efficient, and user-centric software that solves real-world problems.",
    cv: "Download CV",
  },
};
...
const projects = [
  {
    num: "01",
    category: "Fullstack",
    title: { en: "Eco Shop", id: "Eco Shop" },
    description: {
      en: "Fullstack Ecommerce App with Next.js 15, Prisma, and Shadcn UI — Includes Admin Panel with Demo Mode (readonly). Showcase project for portfolio: product listing, cart, checkout with payment gateway XENDIT, order management, and secure admin panel.",
      id: "Aplikasi E-commerce Fullstack dengan Next.js 15, Prisma, dan Shadcn UI — Termasuk Panel Admin dengan Mode Demo (hanya baca). Proyek pameran untuk portofolio: daftar produk, keranjang belanja, proses pembayaran dengan gateway pembayaran XENDIT, manajemen pesanan, dan panel admin yang aman.",
    },
    stack: [
      {
        name: "Next.js",
    ...
    live: "https://eco-shop-viergi.vercel.app/",
    github: "https://github.com/Viergi/eccommerce-nextjs",
  },
  {
    num: "02",
    category: "Fullstack",
